        ...
        public static TheoryData MinimizedAttributeData_Document
        {
            get
            {
                ...
                return new TheoryData<string, MarkupBlock, RazorError[]>
                {
                    ...
                    {
                        $"<input unbound-required class='{expressionString}' />",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "input",
                                selfClosing: true,
                    ...
                    {
                        $"<p bound-string class='{expressionString}'></p>",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "p",
                                selfClosing: false,
                    ...
                    {
                        $"<input class='{expressionString}' unbound-required />",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "input",
                                selfClosing: true,
                    ...
                    {
                        $"<p class='{expressionString}' bound-string></p>",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "p",
                                selfClosing: false,
                    ...
                    {
                        $"<input bound-required-string class='{expressionString}' />",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "input",
                                selfClosing: true,
                    ...
                    {
                        $"<input class='{expressionString}' bound-required-string />",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "input",
                                selfClosing: true,
                    ...
                    {
                        $"<input bound-required-int class='{expressionString}' />",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "input",
                                selfClosing: true,
                    ...
                    {
                        $"<p bound-int class='{expressionString}'></p>",
                        new MarkupBlock(
                            new MarkupTagHelperBlock(
                                "p",
                                selfClosing: false,
